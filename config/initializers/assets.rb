...
# /lib/assets
Rails.application.config.assets.precompile += %w( sb-admin-2.js sb-admin-2.css custom.js custom.css img.jpg undraw_profile.svg undraw_profile_1.svg undraw_profile_2.svg undraw_profile_3.svg )
